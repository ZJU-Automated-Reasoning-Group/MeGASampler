...
all: samples.capnp.h $(SRC) pythonfuncs.c
	g++ -g -std=gnu++17 -O3 -o smtsampler samples.capnp.c++ smtsampler.cpp pythonfuncs.c megasampler.cpp sampler.cpp main.cpp -I/usr/include/python3.9 -L ../z3/build -lz3 -lpython3.9 -lpthread -lcapnp -ljsoncpp
